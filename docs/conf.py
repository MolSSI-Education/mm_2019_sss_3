...
latex_documents = [
    (master_doc, 'mcpy.tex', 'mcpy Documentation',
     'mcpy', 'manual'),
]
...
man_pages = [
    (master_doc, 'mcpy', 'mcpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mcpy', 'mcpy Documentation',
     author, 'mcpy', 'A python package for the MolSSI Software Summer '
                     'School.',
     'Miscellaneous'),
]
